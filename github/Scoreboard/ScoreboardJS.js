...
$(document).ready(function() {
  $(document).on("click", ".front", function() {
    ...
    //Very imp, the next 2 lines must have same value, in this case -45, else toggle breaks.
...
// Power-up button
//RAandom number generayed between 1 to 100
$(".btn-powerup").click(function() {
  var chance = Math.floor(Math.random() * 100) + 1;

  //Setting probability of each powerup
  if (chance < 30) {
