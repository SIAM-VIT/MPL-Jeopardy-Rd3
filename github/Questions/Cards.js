...
//For localStorage notes check Scoreboard.js (top of file)
...
$(".audio-btn1").click(function(){
    $('audio#audio1')[0].play();
    setTimeout(timerdialoguepopup,20000);
})
$(".audio-btn2").click(function(){
    $('audio#audio2')[0].play();
    setTimeout(timerdialoguepopup,17000);
})
$(".audio-btn3").click(function(){
    $('audio#audio3')[0].play();
    setTimeout(timerdialoguepopup,35000);
})
$(".audio-btn4").click(function(){
    $('audio#audio4')[0].play();
})
$(".audio-btn5").click(function(){
    $('audio#audio5')[0].play();
    setTimeout(timerdialoguepopup,54000);
})
$(".audio-btn6").click(function(){
    $('audio#audio6')[0].play();
    setTimeout(timerdialoguepopup,65000);
})

//For wildcard only, on pressing proceed, display text in brackets
// Starts a timer for time specified to indicate end of timer
$(".dialogue-button-proceed").click(function(){
    ...
    setTimeout(timerdialoguepopup,33000);
})

//Checks if a card is flipped or not. If value of array is 0 means not flipped.
// Flips card, changes value to 1, as this is wild card opens popup after 5 seconds ie 5000 milliseconds.
...
// For non wildcard timer depends on score, 100 and 200 questions are 20s, 300 and 400 are 35s and 500 and 600 are 50s, wildcard time depends on question difficulty
...
$(".logo-button-proceed").click(function(){
    ...
    setTimeout(timerlogopopup,45000);
})
...
$(".logo-flip-card-1").click(function(){
    if(logo_flipcheck[0]==0)
    {
        ...
        logo_flipcheck[0]=1;
        setTimeout(timerlogopopup,15000);
    }
    else{
...
$(".logo-flip-card-3").click(function(){
    if(logo_flipcheck[2]==0)
    {
        ...
        logo_flipcheck[2]=1;
        setTimeout(timerlogopopup,30000);
    }
    else{
